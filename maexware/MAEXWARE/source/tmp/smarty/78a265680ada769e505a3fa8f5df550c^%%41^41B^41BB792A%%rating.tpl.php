...
<div class="ratings">
    ...
    <?php if ($this->_tpl_vars['iRatingValue']): ?><?php echo '<div class="d-none" itemtype="http://schema.org/AggregateRating" itemscope="" itemprop="aggregateRating"><span itemprop="worstRating">1</span><span itemprop="bestRating ">5</span><span itemprop="ratingValue">'; ?><?php echo $this->_tpl_vars['iRatingValue']; ?><?php echo '</span><span itemprop="reviewCount">'; ?><?php echo $this->_tpl_vars['oView']->getRatingCount(); ?><?php echo '</span></div>'; ?>
<?php endif; ?>
