<?php /* Smarty version 2.6.34, created on 2025-02-06 16:41:20
         compiled from widget/reviews/reviews.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'oxscript', 'widget/reviews/reviews.tpl', 1, false),array('function', 'oxmultilang', 'widget/reviews/reviews.tpl', 10, false),array('function', 'oxgetseourl', 'widget/reviews/reviews.tpl', 12, false),array('function', 'oxid_include_dynamic', 'widget/reviews/reviews.tpl', 30, false),array('modifier', 'cat', 'widget/reviews/reviews.tpl', 12, false),array('modifier', 'date_format', 'widget/reviews/reviews.tpl', 94, false),array('modifier', 'default', 'widget/reviews/reviews.tpl', 109, false),)), $this); ?>
<?php echo smarty_function_oxscript(array('add' => "$('input,select,textarea').not('[type=submit]').jqBootstrapValidation();"), $this);?>

<?php echo smarty_function_oxscript(array('add' => "$('.ox-write-review').on('click', function () { $('html,body').animate({scrollTop: $('#review').offset().top*0.75}, 1000) })"), $this);?>
            ...
            <div class="card-header toggle-accordion">
                <div class="h4 card-title">
                    <?php if ($this->_tpl_vars['oxcmp_user']): ?>
                        <i class="fas fa-pencil-alt"></i> <a id="writeNewReview" data-toggle="collapse" data-parent="#review_form_accordion" href="#review_form"><?php echo smarty_function_oxmultilang(array('ident' => 'WRITE_REVIEW'), $this);?>
</a>
                    <?php else: ?>
...
?>
                                                    <li class="rating-star s<?php echo $this->_sections['star']['index']; ?>
...
?>
                <div class="card" id="reviewName_<?php echo $this->_foreach['ReviewsCounter']['iteration']; ?>
" itemprop="review" itemscope itemtype="http://schema.org/Review">
                    
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6 writer">
                                    <span itemprop="author" itemscope itemtype="https://schema.org/Person"><span itemprop="name"><?php echo $this->_tpl_vars['review']->oxuser__oxfname->value; ?>
</span></span> <?php echo smarty_function_oxmultilang(array('ident' => 'WRITES'), $this);?>

                                    <span>
                                        <time itemprop="datePublished" content="<?php echo ((is_array($_tmp=$this->_tpl_vars['review']->oxreviews__oxcreate->value)) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")); ?>
...
?>
                        ...
                        <div class="card-body" id="reviewText_<?php echo $this->_foreach['ReviewsCounter']['iteration']; ?>
" itemprop="reviewBody"><?php echo $this->_tpl_vars['review']->oxreviews__oxtext->value; ?>
</div>
