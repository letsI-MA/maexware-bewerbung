<?php /* Smarty version 2.6.34, created on 2025-02-06 15:14:39
         compiled from article_extend.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'oxmultilangassign', 'article_extend.tpl', 1, false),array('modifier', 'oxtruncate', 'article_extend.tpl', 267, false),array('modifier', 'oxformdate', 'article_extend.tpl', 375, false),array('function', 'oxmultilang', 'article_extend.tpl', 69, false),array('function', 'oxinputhelp', 'article_extend.tpl', 90, false),array('block', 'oxhasrights', 'article_extend.tpl', 358, false),)), $this); ?>
...
:&nbsp;<input type="text" class="editinput" size="3" maxlength="<?php echo $this->_tpl_vars['edit']->oxarticles__oxwidth->fldmax_length; ?>
...
:&nbsp;<input type="text" class="editinput" size="3" maxlength="<?php echo $this->_tpl_vars['edit']->oxarticles__oxheight->fldmax_length; ?>
...
:
                    <?php if ($this->_tpl_vars['oView']->getUnitsArray()): ?>
                        <select name="editval[oxarticles__oxunitname]" onChange="JavaScript:processUnitInput( this, 'unitinput' )" <?php echo $this->_tpl_vars['readonly']; ?>
>
                            <option value="">-</option>
                            <?php $_from = $this->_tpl_vars['oView']->getUnitsArray(); if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
" name="editval[oxarticles__oxexturl]" value="<?php echo $this->_tpl_vars['edit']->oxarticles__oxexturl->value; ?>
" <?php echo $this->_tpl_vars['readonly']; ?>
>
...
>
              ...
              <tr>
                ...
                <td class="edittext">
                  ...
                  <input class="edittext" type="checkbox" name="editval[oxarticles__oxskipdiscounts]" value='1' <?php if ($this->_tpl_vars['edit']->oxarticles__oxskipdiscounts->value == 1): ?>checked<?php endif; ?> <?php echo $this->_tpl_vars['readonly']; ?>
>
...
" style="padding-left: 5px;">
          <legend><?php echo smarty_function_oxmultilang(array('ident' => 'ARTICLE_EXTEND_MEDIAURLS'), $this);?>
            ...
            <table cellspacing="0" cellpadding="0" border="0">
                ...
                <?php $_from = $this->_tpl_vars['aMediaUrls']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
