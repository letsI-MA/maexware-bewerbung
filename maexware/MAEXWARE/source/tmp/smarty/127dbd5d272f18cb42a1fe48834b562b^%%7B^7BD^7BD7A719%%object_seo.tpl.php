<?php /* Smarty version 2.6.34, created on 2025-02-06 14:34:24
...
">
 ...
 onChange="document.myedit.submit();" name="aSeoData[oxparams]">
                        ...
                        <?php $_from = $this->_tpl_vars['oView']->getSelectionList(); if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['sListType'] => $this->_tpl_vars['aLangList']):
?>
                            <?php $_from = $this->_tpl_vars['aLangList']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
">
                                    <?php $_from = $this->_tpl_vars['aList']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
